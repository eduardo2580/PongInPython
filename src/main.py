...
PADDLE_WIDTH = 1
PADDLE_HEIGHT = 5
BALL_SPEED_X = 2.00  #ball speed in x direction
BALL_SPEED_Y = 2.00
PADDLE_SPEED = 20
WINNING_SCORE = 5
...
def write_text(writer, text, x, y, font_size=24, align="center", color=WHITE):
    """Helper function to write text"""
    writer.clear()
    writer.color(color)
    writer.goto(x, y)
    writer.write(text, align=align, font=("Courier", font_size, "normal"))
...
def draw_menu():
    ...
    text_turtle.goto(0, 0)
    text_turtle.write("Press ENTER to Start", align="center", font=("Courier", 24, "normal"))
    ...
    text_turtle.write("P: Pause   Space: Reset Ball", align="center", font=("Courier", 16, "normal"))
...
def handle_key_press():
    ...
    wn.onkeypress(reset_ball, "space")
